$(function () {
    ...
    $('.daterangpickerNotDefaultValue').daterangepicker({
        'applyClass': 'btn-sm btn-success',
        'cancelClass': 'btn-sm btn-default',
        autoUpdateInput: true,
        locale: {
...
//Check all grid & checkItem ---------------------------------------------------------------------------------
    $('body').on('click', '#chkAllHeader', function () {
        var cmd = $(this);
        cmd.parent().parent().parent().parent().parent().parent().parent().parent().find('.tblTablList .chkItem').prop('checked', cmd.is(':checked'));

        //get listId
        var _lst = '';
        cmd.parent().parent().parent().parent().parent().parent().parent().parent().find('.tblTablList .chkItem:checked').each(function () {
            _lst += $(this).val() + ',';
        });
        cmd.parent().parent().find('#hidListCheckbox').val(_lst);

    });
    $('body').on('click', '#chkAll', function () {
        var cmd = $(this);
        cmd.parent().parent().parent().parent().parent().find('.chkItem').prop('checked', cmd.is(':checked'));

        //get listId
        var _lst = '';
        cmd.parent().parent().parent().parent().parent().find('.chkItem:checked').each(function () {
            _lst += $(this).val() + ',';
        });
        cmd.parent().parent().find('#hidListCheckbox').val(_lst);
    ...
    $('body').on('click', '.chkItem', function () {
        ...
        //get listId
        var _lst = '';
        cmd.parent().parent().parent().parent().find('.chkItem:checked').each(function () {
            _lst += $(this).val() + ',';
        });
        cmd.parent().parent().parent().parent().parent().parent().parent().parent().find('#hidListCheckbox').val(_lst);
